...
> Idioma: español (para humanos). English version: [README-en.md](README-en.md)
...
→ [Documentación de colores](colors/colors-es.md)
...
→ [Documentación de tipografía](fonts/typography-es.md)
...
→ [Documentación de iconos](icons/icons-es.md)
...
→ [Documentación de espaciado](spacing/spacing-es.md)
